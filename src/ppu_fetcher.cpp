...
void PPU_fetcher::id_step(PPU *ppu){
...
void PPU_fetcher::high_step(PPU *ppu){
  uint8_t ly = ppu->memoria[0xFF44];
  uint8_t y = (!this->window_ativa) ? ppu->get_scrolly() : this->win_line;
